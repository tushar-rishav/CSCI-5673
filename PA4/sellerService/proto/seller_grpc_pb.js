...
function deserialize_seller_authenticateResponse(buffer_arg) {
  return protos_seller_pb.authenticateResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_seller_changeSalePriceRequest(arg) {
  if (!(arg instanceof protos_seller_pb.changeSalePriceRequest)) {
...
function deserialize_seller_changeSalePriceRequest(buffer_arg) {
  return protos_seller_pb.changeSalePriceRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_seller_changeSalePriceResponse(arg) {
  if (!(arg instanceof protos_seller_pb.changeSalePriceResponse)) {
...
function deserialize_seller_changeSalePriceResponse(buffer_arg) {
  return protos_seller_pb.changeSalePriceResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_seller_displayItemResponse(arg) {
  if (!(arg instanceof protos_seller_pb.displayItemResponse)) {
...
function deserialize_seller_displayItemResponse(buffer_arg) {
  return protos_seller_pb.displayItemResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_seller_displayItemsRequest(arg) {
  if (!(arg instanceof protos_seller_pb.displayItemsRequest)) {
...
function deserialize_seller_displayItemsRequest(buffer_arg) {
  return protos_seller_pb.displayItemsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_seller_putAnItemForSaleRequest(arg) {
  if (!(arg instanceof protos_seller_pb.putAnItemForSaleRequest)) {
...
function deserialize_seller_putAnItemForSaleRequest(buffer_arg) {
  return protos_seller_pb.putAnItemForSaleRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_seller_putAnItemForSaleResponse(arg) {
  if (!(arg instanceof protos_seller_pb.putAnItemForSaleResponse)) {
...
function deserialize_seller_putAnItemForSaleResponse(buffer_arg) {
  return protos_seller_pb.putAnItemForSaleResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_seller_rating(arg) {
  if (!(arg instanceof protos_seller_pb.rating)) {
...
function deserialize_seller_rating(buffer_arg) {
  return protos_seller_pb.rating.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_seller_rating_request(arg) {
  if (!(arg instanceof protos_seller_pb.rating_request)) {
    throw new Error('Expected argument of type seller.rating_request');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_seller_rating_request(buffer_arg) {
  return protos_seller_pb.rating_request.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_seller_registerResponse(arg) {
  if (!(arg instanceof protos_seller_pb.registerResponse)) {
...
function deserialize_seller_registerResponse(buffer_arg) {
  return protos_seller_pb.registerResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_seller_rmvAnItemRequest(arg) {
  if (!(arg instanceof protos_seller_pb.rmvAnItemRequest)) {
...
function deserialize_seller_rmvAnItemRequest(buffer_arg) {
  return protos_seller_pb.rmvAnItemRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_seller_rmvAnItemResponse(arg) {
  if (!(arg instanceof protos_seller_pb.rmvAnItemResponse)) {
...
function deserialize_seller_rmvAnItemResponse(buffer_arg) {
  return protos_seller_pb.rmvAnItemResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_seller_userRequest(arg) {
  if (!(arg instanceof protos_seller_pb.userRequest)) {
...
function deserialize_seller_userRequest(buffer_arg) {
  return protos_seller_pb.userRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var SellerSvcService = exports.SellerSvcService = {
  register: {
    ...
    requestType: protos_seller_pb.userRequest,
    responseType: protos_seller_pb.registerResponse,
  ...
  authenticate: {
    ...
    responseStream: false,
    requestType: protos_seller_pb.userRequest,
    responseType: protos_seller_pb.authenticateResponse,
    requestSerialize: serialize_seller_userRequest,
    requestDeserialize: deserialize_seller_userRequest,
  ...
  getSellerRating: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: protos_seller_pb.rating_request,
    responseType: protos_seller_pb.rating,
    requestSerialize: serialize_seller_rating_request,
    requestDeserialize: deserialize_seller_rating_request,
  ...
  putAnItemForSale: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: protos_seller_pb.putAnItemForSaleRequest,
    responseType: protos_seller_pb.putAnItemForSaleResponse,
  ...
  changeSalePrice: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: protos_seller_pb.changeSalePriceRequest,
    responseType: protos_seller_pb.changeSalePriceResponse,
  ...
  rmvAnItem: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: protos_seller_pb.rmvAnItemRequest,
    responseType: protos_seller_pb.rmvAnItemResponse,
  ...
  displayItems: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: protos_seller_pb.displayItemsRequest,
    responseType: protos_seller_pb.displayItemResponse,
